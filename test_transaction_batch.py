...
class TestTransactionCore(unittest.TestCase):
    ...
    def test_get_customer_balance(self):
        ...
        self.assertEqual(self.t.get_customer_balance(adrienne, date3), -40)
        ...
        self.assertEqual(self.t.get_customer_balance(grocery, date2), 20)
        self.assertEqual(self.t.get_customer_balance(grocery, date3), 100)
        ...
        self.assertEqual(self.t.get_customer_balance(insurance, date2), -1)
